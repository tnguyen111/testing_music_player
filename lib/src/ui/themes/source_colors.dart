...
ColorScheme lightMediumContrastScheme() {
  return const ColorScheme(
    ...
    onTertiary: Color(0xffffffff),
    tertiaryContainer: Color(0xff272525),
    onTertiaryContainer: Color(0xffe0dbdb),
    ...
    tertiaryFixed: Color(0xff777474),
    onTertiaryFixed: Color(0xffffffff),
    tertiaryFixedDim: Color(0xff5e5b5b),
...
ColorScheme lightHighContrastScheme() {
  return const ColorScheme(
    ...
    onSecondary: Color(0xffffffff),
    secondaryContainer: Color(0xff444242),
    onSecondaryContainer: Color(0xffffffff),
    tertiary: Color(0xff000000),
    onTertiary: Color(0xffffffff),
    tertiaryContainer: Color(0xff272525),
    ...
    onSurfaceVariant: Color(-11973042),
    ...
    onPrimaryFixedVariant: Color(0xffffffff),
    secondaryFixed: Color(0xff444242),
    onSecondaryFixed: Color(0xffffffff),
...
ColorScheme darkScheme() {
  return const ColorScheme(
    ...
    onPrimaryContainer: Color(0xff9d9b9b),
    ...
    tertiaryContainer: Color(0xff0d0c0c),
    onTertiaryContainer: Color(0xff9e9b9b),
...
ColorScheme darkHighContrastScheme() {
  return const ColorScheme(
    ...
    onSurfaceVariant: Color(-5856092),
    ...
    secondaryFixed: Color(0xffeae6e5),
